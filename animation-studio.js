      ...
      <div class="anim-shell">
        ...
        <aside class="anim-chat">
          ...
          <div class="anim-chat-compose">
            ...
            <div style="font-size:0.65rem;color:rgba(167,139,250,0.85);line-height:1.4;margin:0 0 10px;">Identity = your <strong>Char</strong> upload. Motion = Kling → <strong>DreamActor</strong>.</div>
            <div style="font-size:0.65rem;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin:0 0 6px;">References <span style="font-weight:500;text-transform:none;letter-spacing:0;opacity:0.7;">— Char required · Style optional</span></div>
